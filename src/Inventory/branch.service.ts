 ...
 *
 * Stock write paths do not call this — they need a location, not a branch, and
 * go through `resolveLocation` in `location.service.ts`, which calls the two
 * functions above. This remains for branch-scoped reads and reporting.
 */
