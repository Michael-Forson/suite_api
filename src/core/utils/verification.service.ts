...
import { dispatchOtp } from "../../utils/otp.js";
import { isValidCode } from "../../utils/validators.js";

export type { OtpChannel } from "../../utils/otp.js";
...
export const sendPhoneVerificationCode = async (
  phone: string,
  options?: { channel?: import("../../utils/otp.js").OtpChannel; codeLength?: number; ttlMinutes?: number },
) => {
